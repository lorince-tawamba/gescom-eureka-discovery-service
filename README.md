# Gescom Eureka Discovery Service 

Service d'enrégistrement des Microservices 
...
- gescom-eureka-discovery-service-1.0.0

**Create the docker image**

```bash
  docker build -t lorincetawamba/gescom-eureka-discovery-service:1.0.0 -f Dockerfile .
```
...
```bash
  docker run -d -p 9999:9999 -t lorincetawamba/gescom-eureka-discovery-service:1.0.0
```
...
```bash
  docker image push lorincetawamba/gescom-eureka-discovery-service:1.0.0
```
